...
const PUSH_UP: DemoPosePair = {
  start: [
    ...
    [13, 0.45, 0.65], [14, 0.48, 0.68],
    [15, 0.34, 0.77], [16, 0.37, 0.8],
    [23, 0.61, 0.61], [24, 0.64, 0.64],
...
const LUNGE: DemoPosePair = {
  start: [
    ...
    [23, 0.4, 0.57], [24, 0.47, 0.57],
    [25, 0.32, 0.74], [26, 0.67, 0.7],
    [27, 0.12, 0.82], [28, 0.57, 0.9],
